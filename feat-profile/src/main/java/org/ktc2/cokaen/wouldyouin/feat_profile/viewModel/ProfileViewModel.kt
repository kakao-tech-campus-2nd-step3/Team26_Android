...
class ProfileViewModel @Inject constructor(
    ...
    private val _memberProfile = MutableLiveData<ApiResponseBodyMemberResponse?>()
    val memberProfile: LiveData<ApiResponseBodyMemberResponse?> get() = _memberProfile
